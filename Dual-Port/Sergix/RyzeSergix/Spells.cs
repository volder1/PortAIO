 ...
 namespace RyzeAssembly
{
    class Spells
    {
        ...
        public Spells(){
            _q = new Spell(slot:SpellSlot.Q,range:900,damageType:DamageType.Magical);
            _w = new Spell(slot: SpellSlot.W, range: 600, damageType: DamageType.Magical);
            _e = new Spell(slot: SpellSlot.E, range: 600, damageType: DamageType.Magical);
        ...
        public bool qCastPred()
        {
           ...
           var target = EloBuddy.SDK.TargetSelector.GetTarget(900, DamageType.Magical);
